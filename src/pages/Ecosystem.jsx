...
const Ecosystem = () => {
  return (
    <div className="">
      <section className="w-screen bg-[url('src/assets/ecosystem-bg.png')] bg-center bg-cover min-h-screen p-10 pt-[10vh] text-xl box-border">
        <h1 className='uppercase font-bold text-4xl mb-20'>The Importance of Marine Ecosystem</h1>
