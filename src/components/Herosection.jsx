...
const Herosection = () => {
  ...
  return (
    <div className="bg-[url('src/assets/home.png')] bg-cover bg-center bg-clip-border w-screen h-screen px-1 flex items-center justify-center flex-col text-white">
